                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="content">
                                        ...
                                        //   $r=mysqli_query($conn,"select * from feedback where T_id='$teacher'");
                                        //   $c=mysqli_num_rows($r);
                                        // $teacher = 1; // Replace with the actual teacher ID
                                        $q = mysqli_query($conn, "SELECT AVG(Qn1), AVG(Qn2), AVG(Qn3), AVG(Qn4), AVG(Qn5), AVG(Qn6), AVG(Qn7), AVG(Qn8), AVG(Qn9), AVG(Qn10), AVG(Qn11), AVG(Qn12) FROM feedback WHERE T_id = $teacher");

                                        if ($q) {
                                            $averages = mysqli_fetch_assoc($q);
                                        ...
                                        //   echo "<h4 style='color:black'>$teacher_name got ".$r." feedbacks!</h4>";
                                        //   $i = 1;
                                        ...
                                        //   }
                                          ...
                                          //question 1 start
                                          error_reporting(1);
                                          $q=mysqli_query($conn,"select * from feedback where T_id='$teacher'");
                                          ...
                                          //question 2 start
                                          $q2=mysqli_query($conn,"select * from feedback where T_id='$faculty'");
                                          ...
                                          $q=mysqli_query($conn,"select * from feedback where T_id='$faculty'");
                                          while($res=mysqli_fetch_array($q))
                                          {
                                          $count+=$res[3];
                                          $count+=$res[4];
