<script>
    function confirmDelete(email) {
        ...
        if (confirmDelete) {
            window.location.href = 'delete_faculty.php?T_email=' + email;
        }
    }
</script>
                                        ...
                                        <div class="content" style="padding: 10px">
                                            ...
                                            <div class="row" style="padding: 10px">
                                                ...
                                                while ($row = mysqli_fetch_array($que)) {
                                                    ...
                                                    echo "<td>" . $row['T_desg'] . "</td>";
                                                    echo "<td>" . $row['T_sem'] . "</td>";
                                                    ...
                                                    echo "<td class='text-center'><a href='edit_faculty1.php?email=" . $row['T_email'] . "'>  <i class='pe-7s-pen'></i> </a></td>";

                                                    echo "<td class='text-center'><a href='#' onclick='confirmDelete(\"{$row['T_email']}\")'><i class='pe-7s-close' style='color:red'></i></a></td>";
