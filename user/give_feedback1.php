...
{
$user=$_SESSION['user'];
$sql2=mysqli_query($conn,"select * from teacher where T_email='$faculty'");
$r=mysqli_num_rows($sql);
$teacher = "";
$teachers=mysqli_fetch_assoc($sql2);
foreach ($teachers as $key => $value) {
  if($key=="T_id")
    $teacher = $value;
}
// echo($user);
$sql2=mysqli_query($conn,"select * from students where stu_email='$user'");
$r=mysqli_num_rows($sql);
// echo($r);
$student_id = "";
$students=mysqli_fetch_assoc($sql2);
...
// echo($student_id);
$sql=mysqli_query($conn,"select * from feedback where stu_id='$student_id' and T_id='$teacher'");
$r=mysqli_num_rows($sql);
...
{
$query="insert into feedback values(0, '$student_id','$teacher','$quest1','$quest2','$quest3','$quest4','$quest5','$quest6','$quest7','$quest8','$quest9','$quest10','$quest11','$quest12','$quest13','$quest14')";
// echo($query);
                                ...
                                <div class="content">
                                        ...
                                        <div class="row">
                                          <div class="col-md-6">
                                            ...
                                            <select name="faculty" class="form-control">
                                            	<?php
                                            $sql=mysqli_query($conn,"select * from teacher where T_sem='".$users['stu_semester']."'");
                                            	while($r=mysqli_fetch_array($sql))
                                            	{
                                            	echo "<option value='".$r['T_email']."'>".$r['T_name']."</option>";
                                            	}
                                            		 ?>
                                            </select>
                                        ...
                                        <div class="row">
                                              ...
                                              <div class="form-group" style="padding-left: 5px">
                                                  ...
                                                  <p style="color:black"> Teacher is good at explaining the subject matter:
                                                   ...
                                                   <p style="color:black"> Teacher's presentation was clear,loud and easy to understand:
                                        ...
                                        <div class="form-group" style="padding-left: 5px">
                                            ...
                                            <p style="color:black"> Teacher was always fair and impartial:
                                              <input style="margin-left: 420px" type="radio" name="quest11" value="5" > 5
                                            ...
                                            <p style="color:black"> What I liked/disliked about the class </p>
                                            <textarea style="margin-left: 320px;color:black" name="quest13" rows="5" cols="60" id="comments">
                                            </textarea>

                                            <p style="color:black"> Doubts corner </p>
                                  ...
                                  <p align="center"><button type="submit"  class="btn btn-warning"  name="sub">Submit</button></p>
