...
function confirmDelete(email) {
    ...
    if (confirmDelete) {
        window.location.href = 'delete_student.php?stu_email=' + email;
    }
}
</script>
                  ...
                  <div class="card">
                    ...
                    <div class="content">
                      ...
                      <div class="row">
                        ...
                        $i = 1;
                        $que = mysqli_query($conn, "select * from students");
                        ...
                        while ($row = mysqli_fetch_array($que)) {
                          ...
                          echo "<td class='text-center'><a href='#' onclick='confirmDelete(\"{$row['stu_email']}\")'><i class='pe-7s-close' style='color:red'></i></a></td>";
