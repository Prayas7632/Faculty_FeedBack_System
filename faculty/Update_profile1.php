...
if (isset($save)) {
    ...
    mysqli_query($conn, "update teacher set T_name='$n',T_sem='$sem',T_password='$pass' where T_email='" . $_SESSION['faculty_login'] . "'");

    $err = "<font color='green'>Faculty Details updated</font>";
}

$con = mysqli_query($conn, "select * from teacher where T_email='" . $_SESSION['faculty_login'] . "'");
